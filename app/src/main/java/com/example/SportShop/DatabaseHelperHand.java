...
public class DatabaseHelperHand extends SQLiteOpenHelper {
    private static final String DATABASE_NAME = "hand_database";
    private static final int DATABASE_VERSION = 1;
    private static final String TABLE_NAME = "hand_images"; // Nom de la table spécifique pour le basket
    private static final String COLUMN_ID = "id";
    private static final String COLUMN_IMAGE_DESCRIPTION = "description";

    public DatabaseHelperHand(Context context) {
