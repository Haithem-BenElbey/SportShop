...
public class DatabaseHelperPing extends SQLiteOpenHelper {
    private static final String DATABASE_NAME = "ping_database";
    private static final int DATABASE_VERSION = 1;
    private static final String TABLE_NAME = "imagesP";
    private static final String COLUMN_ID = "id";
    private static final String COLUMN_IMAGE_DESCRIPTION = "description";

    public DatabaseHelperPing(Context context) {
