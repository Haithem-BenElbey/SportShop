...
public class DatabaseHelperTennis extends SQLiteOpenHelper {
    private static final String DATABASE_NAME = "tennis_database";
    private static final int DATABASE_VERSION = 1;
    private static final String TABLE_NAME = "tennis_images"; // Nom de la table spécifique pour le tennis
    private static final String COLUMN_ID = "id";
    private static final String COLUMN_IMAGE_DESCRIPTION = "description";

    public DatabaseHelperTennis(Context context) {
