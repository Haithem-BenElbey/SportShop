...
public class DatabaseHelperVoley extends SQLiteOpenHelper {
    private static final String DATABASE_NAME = "voley_database";
    private static final int DATABASE_VERSION = 1;
    private static final String TABLE_NAME = "itemsV"; // Nom de la table spécifique pour le voley
    private static final String COLUMN_ID = "id";
    private static final String COLUMN_IMAGE_DESCRIPTION = "description";

    public DatabaseHelperVoley(Context context) {
