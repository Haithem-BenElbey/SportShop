...
public class GridAdapter1 extends BaseAdapter {
    ...
    public GridAdapter1(Context context, ArrayList<String> imageDescriptions, int[] imageResources) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        View gridView;
        if (convertView == null) {
            gridView = inflater.inflate(R.layout.grid_item1, null);
    ...
    private void startFootActivity() {
        ...
        Intent intent = new Intent(context, Foot.class);
    ...
    private void startVoleyActivity() {
        ...
        Intent intent = new Intent(context, voley.class);
        context.startActivity(intent);
    }

    private void startHandActivity() {
        // Ajoutez le code pour démarrer l'activité Hand
        Intent intent = new Intent(context, hand.class);
        context.startActivity(intent);
    }
