...
public class GridAdapterbasket extends BaseAdapter {
    ...
    public GridAdapterbasket(Context context, ArrayList<String> imageDescriptions, int[] imageResources) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        View gridView;
        if (convertView == null) {
            gridView = inflater.inflate(R.layout.grid_itembasket, null);
        } else {
        ...
        imageView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(context, ImageDetailsActivityBasket.class);
