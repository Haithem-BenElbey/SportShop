...
public class GridAdapterhand extends BaseAdapter {

    private Context context;
    private ArrayList<String> imageDescriptions;
    private int[] imageResources;

    public GridAdapterhand(Context context, ArrayList<String> imageDescriptions, int[] imageResources) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        View gridView;
        if (convertView == null) {
            gridView = inflater.inflate(R.layout.grid_itemhand, null);
        } else {
        ...
        imageView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(context, ImageDetailsActivityHand.class);
