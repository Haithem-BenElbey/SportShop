...
public class ImageDetailsActivityBoxe extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_image_details_boxe);
        ...
        DatabaseHelperBoxe dbHelper = new DatabaseHelperBoxe(this);
        ...
        buttonSaveDescription.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Toast.makeText(ImageDetailsActivityBoxe.this, "Description updated successfully", Toast.LENGTH_SHORT).show();
                setResult(RESULT_OK);
                finish();
            }
        });
