...
public class ImageDetailsActivityGolf extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_image_details_golf);
        ...
        DatabaseHelperGolf dbHelper = new DatabaseHelperGolf(this);
        ...
        buttonSaveDescription.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Toast.makeText(ImageDetailsActivityGolf.this, "Description updated successfully", Toast.LENGTH_SHORT).show();
                setResult(RESULT_OK);
                finish();
            }
        });
