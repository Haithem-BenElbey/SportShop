...
public class ImageDetailsActivityPing extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_image_details_ping);
        ...
        DatabaseHelperPing dbHelper = new DatabaseHelperPing(this);
        ...
        buttonSaveDescription.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Toast.makeText(ImageDetailsActivityPing.this, "Description updated successfully", Toast.LENGTH_SHORT).show();
                setResult(RESULT_OK);
                finish();
            }
        });
