...
public class ImageDetailsActivityTennis extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_image_details_tennis);
        ...
        DatabaseHelperTennis dbHelper = new DatabaseHelperTennis(this);
        ...
        buttonSaveDescription.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Toast.makeText(ImageDetailsActivityTennis.this, "Description updated successfully", Toast.LENGTH_SHORT).show();
                setResult(RESULT_OK);
                finish();
            }
        });
