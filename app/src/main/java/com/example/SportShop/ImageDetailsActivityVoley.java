...
public class ImageDetailsActivityVoley extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_image_details_voley);
        ...
        DatabaseHelperVoley dbHelper = new DatabaseHelperVoley(this);
        ...
        buttonSaveDescription.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Toast.makeText(ImageDetailsActivityVoley.this, "Description updated successfully", Toast.LENGTH_SHORT).show();
                setResult(RESULT_OK);
                finish();
            }
        });
